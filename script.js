...
function handleScroll() {
  ...
  const isInServicesViewport =
    sectionTop < viewportHeight && sectionTop + sectionHeight > 0;
...
if (document.querySelector("main.main-home")) {
  handleScroll();
}
...
function handleContactForm() {
  ...
  document.getElementById("services").addEventListener("change", function () {
    ...
    if (
      selectedValue === "physiotherapy" ||
      selectedValue === "hydrotherapy" ||
      selectedValue === "mot"
    ) {
      // Show the textarea
...
if (document.querySelector("main.main-contact")) {
  handleContactForm();
}
